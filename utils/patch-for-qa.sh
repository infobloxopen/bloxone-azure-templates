...
SR="[if(contains(parameters('securityGroup'), 'ssh'), concat(if(contains(parameters('securityGroup'), 'bootstrapUi'), variables('securityRuleHtps'), json('[]')), variables('securityRuleSsh')), if(contains(parameters('securityGroup'), 'bootstrapUi'), variables('securityRuleHtps'), json('[]')))]"
