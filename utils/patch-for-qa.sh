...
UI_HOST_SETUP_FIELD='[{"name":"hostSetup","type":"Microsoft.Common.Section","label":"Host setup","elements":[{"name":"accessPortal","type":"Microsoft.Common.TextBox","label":"Access portal","toolTip":"Access portal.","constraints":{"required":false,"regex":"(?=.*).{0,1000}","validationMessage":"The Access portal cannot be more than 1000 characters."},"visible":"true"},{"name":"configServer","type":"Microsoft.Common.TextBox","label":"Config server","toolTip":"Config server.","constraints":{"required":false,"regex":"(?=.*).{0,1000}","validationMessage":"The Config server cannot be more than 1000 characters."},"visible":"true"},{"name":"notificationServer","type":"Microsoft.Common.TextBox","label":"Notification server","toolTip":"Notification server.","constraints":{"required":false,"regex":"(?=.*).{0,1000}","validationMessage":"The Notification server cannot be more than 1000 characters."},"visible":"true"}],"visible":true}]'
